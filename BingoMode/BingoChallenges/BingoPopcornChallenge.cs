    ...
    public class BingoPopcornChallenge : BingoOneCycleChallenge
    {
        ...
        public override void FromString(string args)
        {
            try
            {
                ...
                if (array.Length == 4)
                {
                    region = SettingBoxFromString("System.String|Any Region|Region|1|popcornregions") as SettingBox<string>;
                ...
                else
                {
                    ...
                    _parts[_parts.Length - 1] = "popcornregions"; // Old boards using "popcornRegions"
